...
@implementation NSObject (LXCategory)
...
#define LXPERFORMSELECROR(_args, _return_)\
...
[inv setArgument:&arg atIndex:index]; \
            ...
            case_size(61) case_size(62) case_size(63) case_size(64)
                ...
                NSLog(@"LXCategory performSelectorWithArgs unsupported type:%s (%lu bytes)",
